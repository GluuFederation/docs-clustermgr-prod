...
!!! Note
    If OS of your Gluu nodes is Red Hat, each node is needed to be enabled epel repo as explained [here](/installation/index.md#install-dependencies-on-redhat-7).
