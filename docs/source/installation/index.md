...
- A minimum of four (4) machines:
    - Cluster Manager: One (1) machine running **Ubuntu (18, 20), CentOS (7) or RHEL (7)** with at least 4GB of RAM for cluster manager, which will proxy TCP and HTTP traffic.
    ...
    - Gluu Server(s): At least two (2) machines running Ubuntu (18, 20), CentOS (7) or RHEL (7) for Gluu Servers.
    - Redis Cache Server: One (1) machine running Ubuntu (18, 20), CentOS (7) or RHEL (7) with at least 4GB of RAM
...
wget -q https://ox.gluu.org/maven/org/gluu/oxlicense-validator/4.2.0.Final/oxlicense-validator-4.2.0.Final-jar-with-dependencies.jar -O $HOME/.clustermgr4/javalibs/oxlicense-validator.jar
```
